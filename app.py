...
def patient_dashboard():
    ...
    return render_template('patient_dashboard.html', user=g.user, appointments=appointments, details=patient_details, medical_history=history, full_dashboard=True)
